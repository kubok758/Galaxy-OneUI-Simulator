...
export function AppDrawer({ onClose }: { onClose: () => void }) {
  ...
  return (
    <motion.section initial={{ y: '100%' }} animate={{ y: 0 }} exit={{ y: '100%' }} transition={{ type: 'spring', stiffness: 300, damping: 32 }} className="absolute inset-0 z-50 overflow-y-auto bg-zinc-950/92 px-5 pb-20 pt-12 backdrop-blur-2xl" aria-label="Меню приложений">
